    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/financial" element={<ProtectedRoute allowedRole="professor"><Financial /></ProtectedRoute>} />
          <Route path="/reports" element={<ProtectedRoute allowedRole="professor"><Reports /></ProtectedRoute>} />
