    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      {selectedStudent && (
        <>
          ...
          <JourneyWorkoutsDialog open={showJourneyWorkouts} onOpenChange={setShowJourneyWorkouts} journeyId={activeJourney?.id || ""} journeyName={activeJourney?.name || ""} journeyFormat={activeJourney?.format || ""} studentName={selectedStudent.full_name} studentId={selectedStudent.id} />
